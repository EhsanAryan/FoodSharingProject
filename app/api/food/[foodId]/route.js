...
import { checkIsFavorite, checkIsOwner, checkTokenIsValid } from "@/app/actions/actions";
...
export async function GET(request, context) {
    try {
        ...
        const is_owner = await checkIsOwner(food.creator._id.toString());
        const is_favorite = await checkIsFavorite(foodId);
